  ...
  useEffect(() => {
    async function loadProjects() {
      try {
        ...
        const videoProjects = (data.projects || []).filter(
        ...
        console.error(
          "Failed to load video editing projects:",
          error
        );

        setError(
          "Unable to load video editing projects."
        );
      } finally {
        setLoading(false);
      }
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <Reveal delay={0.2}>
              <p className="mt-10 max-w-2xl text-base leading-8 text-white/45 md:text-lg">
                A selection of video editing, motion,
                short-form content, and cinematic storytelling
                created for creators, brands, and digital
                campaigns.
              </p>
            </Reveal>
          </div>
